        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        case SD.ManagerRole:
                            await _userManager.AddToRoleAsync(user, SD.ManagerRole); break;
                        case SD.KitchenRole:
                            await _userManager.AddToRoleAsync(user, SD.KitchenRole); break;
                        case SD.FrontDeskRole:
                            await _userManager.AddToRoleAsync(user, SD.FrontDeskRole); break;
                        default:
